...
public class LoginTC extends Base {
	...
	{   
		...
		if (er1=true) 
		{
		  ...
		  Screenshots.TakesScreenshots(driver, "C:\\Users\\Akhalesh\\git\\CP_BPTCRepo\\CP-BPTC_Framework\\src\\BPTC\\utilities\\Screenshots\\Login\\Msg_InvalidCredentials.jpeg");
		}
		 else if (Menu1=true)
				{
				...
				Screenshots.TakesScreenshots(driver, "C:\\Users\\Akhalesh\\git\\CP_BPTCRepo\\CP-BPTC_Framework\\src\\BPTC\\utilities\\Screenshots\\Login\\LoggedWithValidCredentials.jpeg");
				}
			    else {
		      ...
		      Logs.Takelog("LoginTC", "Login test -Fail for valid credential, it does not redirect to home screen for valid credentials"+Userid+" "+Password);
		       Screenshots.TakesScreenshots(driver, "C:\\Users\\Akhalesh\\git\\CP_BPTCRepo\\CP-BPTC_Framework\\src\\BPTC\\utilities\\Screenshots\\Login\\LoginFailedForValidCredentials.jpeg");
			    }
	}
	catch(Exception e) {
		Logs.Takelog("LoginTC", e.getMessage());
		Screenshots.TakesScreenshots(driver, "C:\\Users\\Akhalesh\\git\\CP_BPTCRepo\\CP-BPTC_Framework\\src\\BPTC\\utilities\\Screenshots\\Login\\LoginException.jpeg");
